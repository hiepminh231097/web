    ...
    <main class="app-content">
      <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item active"><a href="#"><b>Danh sách môn nhập điểm</b></a></li>
        </ul>
        <div id="clock"></div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
			...
			require_once('../connect/ketnoi.php');
                ...
                $sql="SELECT DISTINCT mh.MaMH,mh.TenMH FROM monhoc mh,dangkymh dk,danhsachdk ds WHERE mh.MaMH=dk.MaMH and mh.MaMH=ds.MaMH and dk.MaMH=ds.MaMH and dk.MaMH=dk.MaMH";
                $kq=mysqli_query($conn,$sql);
                 ...
                 echo" <tr>";
                   ...
                   echo" <td>
                                    <a class='btn btn-primary btn-sm edit' href='nhapdiemm.php?MaMH=".$MaMH."'> <i class='fas fa-edit'></i>
                    </a></td>";
                  echo" </tr>";
				  }
					  ?>
