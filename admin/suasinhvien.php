  ...
  <aside class="app-sidebar">
    ...
    <hr>
     <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="../index/danhsachmonhocmo.php"><i
  ...
  <main class="app-content">
    <div class="app-title">
       <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Sửa sinh viên</a></li>
      </ul>
      <div id="clock"></div>
    </div>
<form method="post" action="">
        ...
        <div class="modal-body">
          ...
          <?php
            ...
            echo"<div class='form-group col-md-6'>
              ...
              <input class='form-control' type='text' name='MaSV'  value='$row[MaSV]' >
            </div>";
           echo"<div class='form-group col-md-6'>
              <label class='control-label'>Tên sinh viên</label>
              <input class='form-control' type='text' name='TenSV'  value='$row[TenSV]' >
            </div>";
           echo"<div class='form-group col-md-6'>
              <label class='control-label'>Giới tính</label>
              <input class='form-control' type='text' name='gioitinh'  value='$row[GioiTinh]' >
            </div>";
            echo"<div class='form-group col-md-6'>
              <label class='control-label'>Dân tộc</label>
              <input class='form-control' type='text' name='dantoc'  value='".$row['DanToc']."' >
            </div>";
           echo" <div class='form-group col-md-6'>
              <label class='control-label'>Ngày sinh</label>
              <input class='form-control' type='date' name='ngaysinh' value='$row[NgaySinh]'>
            </div>";
            echo"<div class='form-group col-md-6'>
		     ...
		     echo"<div class='form-group col-md-6'>
              ...
              <input class='form-control' type='text' name='gmail'  value='$row[Gmail]' >
            </div>";
			 echo"<div class='form-group col-md-6'>
	...
	if(isset($_POST['LUU']))
	{
		...
		$gmail = $_POST['gmail'];
		$sdt = $_POST['sdt'];
		$sql="UPDATE sinhvien SET MaSV='$Masv', TenSV='$TenSV',GioTinh='$gioitinh',DanToc='$dantoc', NgaySinh='$ngaysinh',NoiSinh='$noisinh',Gmail='$gmail',SDT='$sdt' WHERE MaSV='$MaSV'";
		mysqli_query($conn,$sql);
		echo "Sửa thông tin thành công.  <a href='../index/quanlysinhvien.php' style='color:red;'>Trở lại</a>";
        exit;
	}
...
?>
          ...
          <BR>
          <BR>
        <form method="POST" style="margin: 10px"> <input class="btn btn-cancel" type="submit" name="LUU" value="LƯU"></form>
          <a class="btn btn-cancel" data-dismiss="modal" href="../index/quanlysinhvien.php">Hủy bỏ</a>
          <BR>
        </div>
